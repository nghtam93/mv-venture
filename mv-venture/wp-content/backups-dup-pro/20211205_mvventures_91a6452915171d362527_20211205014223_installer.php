...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20211205_mvventures_91a6452915171d362527_20211205014223_archive.daf';
    const ARCHIVE_SIZE       = '67142582';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = '91a6452-05014223';
    const VERSION            = '3.8.7';
